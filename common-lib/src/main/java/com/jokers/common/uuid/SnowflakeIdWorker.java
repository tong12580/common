    ...
    public static SnowflakeIdWorker getInstance(long workerId, long datacenterId) {
        if (snowflakeIdWorker == null) {
            synchronized (SnowflakeIdWorker.class) {
                ...
                if (snowflakeIdWorker.datacenterId != datacenterId || snowflakeIdWorker.workerId != workerId) {
                    snowflakeIdWorker = new SnowflakeIdWorker(workerId, datacenterId);
                }
            }
        }
...
//        SnowflakeIdWorker idWorker = SnowflakeIdWorker.getInstance(3, 0);
//        for (int i = 0; i < 10; i++) {
//            long id = idWorker.nextId();
//            System.out.println("int i is" + i + "," + id);
//        }
//        SnowflakeIdWorker idWorker2 = SnowflakeIdWorker.getInstance(1, 1);
//        for (int i = 0; i < 10; i++) {
